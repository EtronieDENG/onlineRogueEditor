...
class ModifierType(Enum):
    ...
    # Vitamins
    HP_UP = Modifier(args=[None, 0], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[0], description='Increases HP.', customName='HP Up', customType='Vitamin', maxStack='31')
    PROTEIN = Modifier(args=[None, 1], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[1], description='Increases Attack.', customName='Protein', customType='Vitamin', maxStack='31')
    IRON = Modifier(args=[None, 2], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[2], description='Increases Defense.', customName='Iron', customType='Vitamin', maxStack='31')
    CALCIUM = Modifier(args=[None, 3], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[3], description='Increases Special Attack.', customName='Calcium', customType='Vitamin', maxStack='31')
    ZINC = Modifier(args=[None, 4], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[4], description='Increases Special Defense.', customName='Zinc', customType='Vitamin', maxStack='31')
    CARBOS = Modifier(args=[None, 5], className='PokemonBaseStatModifier', player=True, stackCount=1, typeId='BASE_STAT_BOOSTER', typePregenArgs=[5], description='Increases Speed.', customName='Carbos', customType='Vitamin', maxStack='31')
    #X Attack
    ...
    FLAME_ORB = Modifier(args=[None], className='TurnStatusEffectModifier', player=True, stackCount=1, typeId='FLAME_ORB', shortDescription='Burn your pokemon', description='Burns its holder at the end of the turn if they do not have a status condition already.', customName='Fire Orb', customType='Orb', maxStack='1')
...
class ModifierEditor:
    ...
    def m_createItemMenu(self):
        ...
        m_itemMenuItems.append((('全道具', "不知道要啥道具就选这个！"), self.__fh_doAllModifiers))
    ...
    def __f_recursiveAddOrUpdateMods(self, data, modifierType: ModifierType, stack, pokeId, sessionSlot):
        try:
            ...
            self.notifyMessage = (f'成功添加 {modifier.typeId}', 'success')
    ...
    def fh_printParty(self, slotData):
        ...
        cFormatter.print(Color.WHITE, '当前队伍')
    ...
    def __fh_doAllModifiers(self, sessionSlot):
        try:
            ...
            try:
                ...
                self.notifyMessage = ('成功添加非负面效应的全道具', 'success')
    ...
    @staticmethod
    def end():
        cFormatter.print(Color.GREEN, '正退出修改器')
